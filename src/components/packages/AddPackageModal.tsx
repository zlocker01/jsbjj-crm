...
import type { PackageFormData } from '@/schemas/packagesSchemas/packageSchema';
...
export function AddPackageModal({
  ...
  const handleFileChange = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const fileName = `landing/${landingId}/packages/${Date.now()}-${cleanName}`;
  ...
  // Componente auxiliar para inputs de array
  const ArrayInput = ({
    field,
    label,
    placeholder,
